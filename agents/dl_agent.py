"""
DL Agent
Perception : CLIP zero-shot classification of map screenshot
Planning   : Anthropic Claude API for rich itinerary generation
...
class DLAgent:
    ...
    def plan(self, region_info, preferences=None, conversation_history=None):
        ...
        style = preferences.get("style", "balanced")  # adventure / relaxation / cultural / balanced
        budget_level = preferences.get("budget", "mid-range")  # budget / mid-range / luxury
        ...
        system_prompt = (
            ...
            "Format: {\"itinerary\": [{\"day\": \"Day 1\", \"theme\": \"...\", \"morning\": \"...\", \"afternoon\": \"...\", \"evening\": \"...\", \"tip\": \"...\"}], "
            "\"food\": [\"dish1\", \"dish2\", \"dish3\"], "
            "\"best_season\": \"...\", \"budget\": \"...\", \"tips\": [\"tip1\", \"tip2\"], \"highlights\": [\"h1\", \"h2\"]}"
        )
